...
export const PATH_DASHBOARD = {
  ...
  orders: {
    ...
    detail: (id: any) => path(ROOTS_DASHBOARD, `/orders/detail/${id}`),
    medias: path(ROOTS_DASHBOARD, '/orders/medias'),
    editMediaById: (id: number) => path(ROOTS_DASHBOARD, `/orders/${id}/medias`)
  },
  configuration: {
    root: path(ROOTS_DASHBOARD, '/configuration'),
    list: path(ROOTS_DASHBOARD, '/configuration')
  }
};
